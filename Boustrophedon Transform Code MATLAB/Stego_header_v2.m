clc;
clear all;
my_image=imread('C:\Users\SRISHTI\Desktop\New Folder\fruit.bmp');
secret_image=imread('C:\Users\SRISHTI\Desktop\New Folder\cover_img.bmp');
secret_image_resize=imresize(secret_image,[255,255]);
imwrite(secret_image_resize,'C:\Users\SRISHTI\Desktop\New Folder\secret1.bmp');
headerlength=32;
[R,C]=size(my_image);
...
imwrite(my_image,'C:\Users\SRISHTI\Desktop\New Folder\fruit.bmp');
[R,C]=size(my_image);
bin=zeros(R,C,'uint8');
...
imshow(bin);
imwrite(bin,'C:\Users\SRISHTI\Desktop\New Folder\stego_img.bmp');